...
// load src
Fr_add(&expaux[0],&signalValues[mySignalStart + 1],&circuitConstants[1]); // line circom 15
// end load src
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 2],&circuitConstants[2]); // line circom 16
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 3],&signalValues[mySignalStart + 4]); // line circom 18
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
for (uint i = 0; i < 0; i++){
